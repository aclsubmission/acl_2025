...
class CustomDataset(Dataset):
    def __init__(self, encoder_embedding, y_map, R, type='clean'):
...
def train_and_evaluate(encoder_embedding, R, type):
    y_map = {}
    c = 0
    ...
    dataset = CustomDataset(encoder_embedding, y_map, R, type)
...
for model in model_list:
    for data in data_list:
        ...
        print('data loaded')        
        R = len(encoder_embedding[0][2])
        accuracy = train_and_evaluate(encoder_embedding,R, type)
        print(accuracy)
